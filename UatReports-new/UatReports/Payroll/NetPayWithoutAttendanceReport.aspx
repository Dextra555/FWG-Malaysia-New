<%@ page language="C#" autoeventwireup="true" inherits="PayRoll_NetPayWithoutAttendanceReport, App_Web_402qaw3v" title="e-Security Management System" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportSource ID="crptNetpay" runat="server">
                <Report FileName="SalaryStatementWithoutAttendance.rpt">
                </Report>
