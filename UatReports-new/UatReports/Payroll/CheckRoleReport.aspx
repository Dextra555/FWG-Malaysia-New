<%@ page language="C#" autoeventwireup="true" inherits="PayRoll_CheckRoleReport, App_Web_402qaw3v" title="e-Security Management System" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportSource ID="crptCheckRole" runat="server">
                <Report FileName="CheckRoleReport.rpt">                   
                    <DataSources>
