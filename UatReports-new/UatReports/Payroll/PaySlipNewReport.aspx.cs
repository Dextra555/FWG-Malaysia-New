...
public partial class PayRoll_PaySlipNewReport : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
        try
        {
            ...
            if (Request.QueryString["Lang"] == "M")
                crptPaySlip.Report.FileName = "PaySlip_New.rpt";
            else
                crptPaySlip.Report.FileName = "PaySlip_New.rpt";
...
string connStr = System.Configuration.ConfigurationManager.ConnectionStrings["obms"]?.ConnectionString
            ...
            {                
                crptPaySlip.ReportDocument.RecordSelectionFormula += " AND {vwPaySheet.EMP_CODE}='" + Request.QueryString["Employee"] + "'";
            }
        }
