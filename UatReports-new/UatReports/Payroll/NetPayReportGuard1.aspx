<%@ page language="C#" autoeventwireup="true" inherits="PayRoll_NetPayReportGuard1, App_Web_402qaw3v" title="e-Security Management System" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportSource ID="crptNetpay" runat="server">
                <Report FileName="..\Payroll\SalaryStatementGuard1.rpt">
                    <DataSources>
