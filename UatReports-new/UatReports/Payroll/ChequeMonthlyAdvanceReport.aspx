<%@ page language="C#" autoeventwireup="true" inherits="PayRoll_ChequeMonthlyAdvanceReport, App_Web_402qaw3v" title="e-Security Management System" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportSource ID="crptBankAdvance" runat="server">
                <Report FileName="..\Payroll\ChequeMonthlyAdvanceReport.rpt">
                    <DataSources>
