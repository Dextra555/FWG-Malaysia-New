...
public partial class PayRoll_CheckRoleReport : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
        try
        {
            ...
            ParameterDiscreteValue paramClient = new ParameterDiscreteValue();
            paramClient.Value = Request.QueryString["Client"];

            ParameterDiscreteValue paramNoOfHours = new ParameterDiscreteValue();
            paramNoOfHours.Value = Request.QueryString["NoOfHours"];
            ...
            crptCheckRoleList.ParameterFieldInfo["Client"].CurrentValues.Add(paramClient);          
            crptCheckRoleList.ParameterFieldInfo["TotalAgreementHours"].CurrentValues.Add(paramNoOfHours);
        }
