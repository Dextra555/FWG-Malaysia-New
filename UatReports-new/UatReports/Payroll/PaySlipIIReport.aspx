<%@ page language="C#" autoeventwireup="true" inherits="PayRoll_PaySlipIIReport, App_Web_402qaw3v" title="e-Security Management System" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportSource ID="crptPaySlip" runat="server">
                <Report FileName="PaySlipSTM.rpt">
                    <DataSources>
