...
public partial class PayRoll_TimeSheetReportIII : System.Web.UI.Page
{
...
string connStr = System.Configuration.ConfigurationManager.ConnectionStrings["obms"]?.ConnectionString
            ...
            {
                crptPaySlip.ReportDocument.RecordSelectionFormula += " AND {vwTimeSheet.EMP_CODE}='" + Request.QueryString["Employee"] + "'";
            }
        }
