<%@ page language="C#" autoeventwireup="true" inherits="PayRoll_DailyAdvanceReport, App_Web_402qaw3v" title="e-Security Management System" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <cr:crystalreportsource id="crptBankAdvance" runat="server">
                <report filename="..\Payroll\DailyAdvanceReport.rpt">
                    <datasources>
