...
public partial class Finance_ReceiptSummaryReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                CrystalReportSource.ReportDocument.RecordSelectionFormula += " AND {Receipts.Branch}='" + Request.QueryString["Branch"] + "'";
            }            
        }
