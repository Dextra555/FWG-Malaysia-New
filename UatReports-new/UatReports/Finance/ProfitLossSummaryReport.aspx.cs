...
public partial class Finance_ProfitLossSummaryReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            CrystalReportViewer.ParameterFieldInfo["ePeriod"].CurrentValues.Add(paramStartDate);
            CrystalReportViewer.ParameterFieldInfo["sPeriod"].CurrentValues.Add(paramEndDate);
            CrystalReportViewer.ParameterFieldInfo["LoginID"].CurrentValues.Add(paramUserName);
            if (Request.QueryString["Branch"] != "0")
            {
                CrystalReportSource.ReportDocument.RecordSelectionFormula += "{command.Branch}='" + Request.QueryString["Branch"] + "'";
            }
