...
public partial class _Default : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            ParameterDiscreteValue paramChequeStatus = new ParameterDiscreteValue();
            paramChequeStatus.Value = Request.QueryString["ChequeStatus"];


            ParameterDiscreteValue paramBankcode = new ParameterDiscreteValue();
            paramBankcode.Value = Request.QueryString["Bankcode"];
            ...
            CrystalReportViewer.ParameterFieldInfo["ChequeStatus"].CurrentValues.Add(paramChequeStatus);

            CrystalReportViewer.ParameterFieldInfo["bankcode"].CurrentValues.Add(paramBankcode);


            switch (Request.QueryString["ChequeStatus"])
            {
                case "P":
                    paramReportTitle.Value = "Pending Cheques from " + Request.QueryString["StartDate"] + " to " + Request.QueryString["EndDate"];
                    CrystalReportViewer.ParameterFieldInfo["ReportTitle"].CurrentValues.Add(paramReportTitle);
                    break;
                case "D":
                    paramReportTitle.Value = "Deposited Cheques from " + Request.QueryString["StartDate"] + " to " + Request.QueryString["EndDate"];
                    CrystalReportViewer.ParameterFieldInfo["ReportTitle"].CurrentValues.Add(paramReportTitle);
                    break;
                case "R":
                    paramReportTitle.Value = "Returned Cheques from " + Request.QueryString["StartDate"] + " to " + Request.QueryString["EndDate"];
                    CrystalReportViewer.ParameterFieldInfo["ReportTitle"].CurrentValues.Add(paramReportTitle);
                    break;
            }
