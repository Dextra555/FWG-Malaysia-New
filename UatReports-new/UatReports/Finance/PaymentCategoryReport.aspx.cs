...
public partial class Finance_PaymentCategoryReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            paramCategory.Value = Request.QueryString["Category"] ?? string.Empty;

            ParameterDiscreteValue paramUserName = new ParameterDiscreteValue();
            paramUserName.Value = Request.QueryString["LoginID"] ?? string.Empty;

            // Apply company header parameters
            ...
            // Apply report-specific parameters
