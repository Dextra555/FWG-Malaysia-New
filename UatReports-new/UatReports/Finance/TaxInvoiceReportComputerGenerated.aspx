<%@ page language="C#" autoeventwireup="true" inherits="Finance_TaxInvoiceReportComputerGenerated, App_Web_zojcqgwf" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportSource ID="CrystalReportSource" runat="server">
                <Report FileName="TaxInvoiceReportComputerGenerated.rpt">
                    <DataSources>
