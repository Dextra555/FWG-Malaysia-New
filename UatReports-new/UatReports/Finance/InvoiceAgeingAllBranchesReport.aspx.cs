...
public partial class Finance_InvoiceAgeingAllBranchesReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            // All Branches — no branch filter applied
            string branchFilter = "1=1";
...
ORDER BY A.Branch, A.Client",
                sd_str,             // {0} start date
                ed_str,             // {1} end date
                branchFilter,       // {2} always 1=1
            ...
            SetViewerParam("Branch",              "All");
            SetViewerParam("BranchCode",          "All");
            ...
            // Apply record selection for MasterClient / Client if needed
            ...
            // Data is already ordered by Branch, Client via SQL ORDER BY.
            // Crystal Reports will group branch-by-branch based on that order.
        }
        catch (Exception ex)
        {
