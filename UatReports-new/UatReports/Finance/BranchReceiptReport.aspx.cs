...
public partial class Finance_BranchReceiptReport : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
        try
        {
            ...
            ParameterDiscreteValue paramReceiptID = new ParameterDiscreteValue();
            paramReceiptID.Value = Request.QueryString["ID"];
            ...
            CrystalReportViewer.ParameterFieldInfo["ReceiptID"].CurrentValues.Add(paramReceiptID);
