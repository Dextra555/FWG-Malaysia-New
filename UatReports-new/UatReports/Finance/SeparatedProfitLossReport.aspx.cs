...
public partial class Finance_SeparatedProfitLossReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            paramStartDate.Value = DateTime.Parse(startDateStr);

            ParameterDiscreteValue paramEndDate = new ParameterDiscreteValue();
            paramEndDate.Value = DateTime.Parse(endDateStr);
            ...
            CrystalReportViewer.ParameterFieldInfo["LoginID"].CurrentValues.Add(paramLoginID);
        }
